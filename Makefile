...
release:
	sed -i '' 's/tests.common.test_common_Configuration/draft.configuration.Configuration/' draft/new/main.py draft/debug/main.py
	sed -i '' 's/tests.new.test_Compiler/draft.new.Compiler/' draft/new/Subcommands.py
debug:
	sed -i '' 's/draft.configuration.Configuration/tests.common.test_common_Configuration/' draft/new/main.py draft/debug/main.py
